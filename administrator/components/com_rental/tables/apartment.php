 ...
 * @since		1.5
 */
class RentalTableApartment extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__rental_apartments', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Apartment', 'RentalTable');
			...
			/*
			$table = JTable::getInstance('Apartment', 'RentalTable');
