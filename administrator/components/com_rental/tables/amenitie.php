 ...
 * @since		1.5
 */
class RentalTableAmenitie extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__rental_amenities', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Amenitie', 'RentalTable');
			...
			/*
			$table = JTable::getInstance('Amenitie', 'RentalTable');
