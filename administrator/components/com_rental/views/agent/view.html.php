...
/**
 * View to edit a agent.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_rental
 * @since		1.5
 */
class RentalViewAgent extends JView
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_RENTAL_MANAGER_AGENT_NEW') : JText::_('COM_RENTAL_MANAGER_AGENT_EDIT'), '#xs#.png');
		...
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::save2copy('agent.save2copy');
		}
