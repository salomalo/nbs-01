...
/**
 * @package		Joomla.Site
 * @subpackage	mod_rental_feature_listings
...
?>
<ul id="listings">
    <li id="listing_728295" class="reset">
      <div style="display: none;" class="detailsOverlay hidden ">
        <div class="rent">$4,700</div>
    ...
    <li id="listing_733071" class="reset">
      <div class="detailsOverlay hidden ">
        <div class="rent">$4,600</div>
    ...
    <li id="listing_733090" class="reset">
      <div class="detailsOverlay hidden ">
        <div class="rent">$3,900</div>
        <div class="title bold">3br</div>
        <div class="neighborhood">Gramercy</div>
      </div>
      ...
      <li class="last number">
        <div class="text">13,947
            <span class="small">NYC apartments</span>
        </div>
      </li>

    <li id="listing_736585" class="reset">
      <div style="display: none;" class="detailsOverlay hidden ">
    ...
    <li id="listing_736649" class="reset">
      <div class="detailsOverlay hidden ">
        <div class="rent">$5,460</div>
        <div class="title bold">3br</div>
    ...
    <li id="listing_736729" class="reset">
      <div class="detailsOverlay hidden ">
        <div class="rent">$1,975</div>
        <div class="title bold">1br</div>
        <div class="neighborhood">Upper East Side</div>
      </div>
      ...
      <li class="last number">
          <div class="text">1,498
              <span class="small">no fee apartments</span>
          </div>
      </li>
    <li id="listing_737177" class="reset">
      <div style="display: none;" class="detailsOverlay hidden ">
        <div class="rent">$1,545</div>
    ...
    <li id="listing_737461" class="reset">
      <div class="detailsOverlay hidden ">
        <div class="rent">$2,995</div>
        <div class="title bold">1br</div>
    ...
    <li id="listing_738310" class="reset">
      <div class="detailsOverlay hidden ">
        <div class="rent">$2,850</div>
        <div class="title bold">2br</div>
        <div class="neighborhood">Gramercy</div>
      </div>
