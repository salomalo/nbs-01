 ...
 * @since		1.5
 */
class RentalTableImage extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__retal_apartment_images', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Image', 'RentalTable');
			...
			/*
			$table = JTable::getInstance('Image', 'RentalTable');
