 ...
 * @since		1.5
 */
class RentalTableLocation extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__retal_location', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Location', 'RentalTable');
			...
			/*
			$table = JTable::getInstance('Location', 'RentalTable');
